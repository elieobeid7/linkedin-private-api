...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:4](https://github.com/elieobeid7/linkedin-private-api/blob/d9248d2/src/entities/linkedin-image-view-model.entity.ts#L4)*
...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:5](https://github.com/elieobeid7/linkedin-private-api/blob/d9248d2/src/entities/linkedin-image-view-model.entity.ts#L5)*
